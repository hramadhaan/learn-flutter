...
class _$RegisterObjectCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? countryMobilePhone = freezed,
    ...
    return _then(_value.copyWith(
      countryMobilePhone: countryMobilePhone == freezed
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.countryMobilePhone, this.mobileNumber, this.userName,
  ...
  @override
  String toString() {
    return 'RegisterObject(countryMobilePhone: $countryMobilePhone, mobileNumber: $mobileNumber, userName: $userName, email: $email, password: $password, profilePicture: $profilePicture)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.countryMobilePhone, countryMobilePhone) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(countryMobilePhone),
